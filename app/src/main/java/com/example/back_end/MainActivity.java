...
public class MainActivity extends AppCompatActivity {
    ...
    String url = "http://192.168.1.4/Volley/ws/find.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new EtudiantAdapter(MainActivity.this, etudiantList);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    // Notifiez l'adapter que les données ont changé
                    adapter.notifyDataSetChanged();

                    // Ajoutez la gestion de la suppression par glissement
